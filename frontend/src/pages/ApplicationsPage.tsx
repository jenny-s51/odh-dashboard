      ...
      return (
        <PageSection isFilled>
          <EmptyState variant={EmptyStateVariant.lg} data-id="error-empty-state">
            <EmptyStateHeader titleText={<>{errorMessage !== undefined ? errorMessage : 'Error loading components'}</>} icon={<EmptyStateIcon icon={ExclamationCircleIcon} />} headingLevel="h4" />
      ...
      return !emptyStatePage ? (
        <PageSection isFilled>
          <EmptyState variant={EmptyStateVariant.lg} data-id="empty-empty-state">
            <EmptyStateHeader titleText={<>{emptyMessage !== undefined ? emptyMessage : 'No Components Found'}</>} icon={<EmptyStateIcon icon={QuestionCircleIcon} />} headingLevel="h4" />
          </EmptyState>
        </PageSection>
      ) : (
        emptyStatePage
