  ...
  return (
    <>
      <DetailsSectionAlt
        ...
        badge={!isDataConnectionsEmpty && <Badge style={{ marginLeft: 'var(--pf-v5-global--spacer--sm)' }}>{connections.length}</Badge>}
        title={ !isDataConnectionsEmpty && ProjectSectionTitles[ProjectSectionID.DATA_CONNECTIONS] || ''}
        popover={ !isDataConnectionsEmpty &&
          <Popover
