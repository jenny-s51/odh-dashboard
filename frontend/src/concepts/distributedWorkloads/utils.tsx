...
import {
  chart_color_teal_300 as chartColorTeal,
  chart_color_red_orange_300 as chartColorOrangeRed,
...
> = {
  Pending: {
    color: 'teal',
    chartColor: chartColorTeal.value,
    icon: PendingIcon,
  },
  Inadmissible: {
    color: 'orangered',
    chartColor: chartColorOrangeRed.value,
