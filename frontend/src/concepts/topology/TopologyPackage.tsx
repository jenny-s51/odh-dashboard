...
import { generateDataModel, generateEdge, generateNode, updateGroup } from "./generator";
import defaultComponentFactory from "./defaultcomponentFactory";
import defaultLayoutFactory from "./defaultLayoutFactory";
  ...
  return (
    <div className="pf-ri__topology-demo">
      <Tabs unmountOnExit activeKey={activeKey} onSelect={handleTabClick}>
        ...
        <Tab eventKey={1} title={<TabTitleText>With Resizeable Side Bar</TabTitleText>}>
